...
module z_motor_mount_old() {
    ...
    intersection() {
        difference() {
            union() {
                difference() {
                    translate([-15.5, 0, 32.5/2 - 3])
                    cube([72, l, 34.5], center=true);

                    translate([56, 0, 5])
                    rotate([0, -45, 0])
                    cube([50, 80, 500], center=true);
                }

                translate([-30/2 - z_screw_d/2 - 1, 0, -3.99])
                intersection() {
                    translate([0, 0, 0])
                    rotate([180, 0, 0])
                    long_tie(l + 10);
            ...
            translate([-30/2 - z_screw_d/2 - 1, 0, 50/2 + 5])
            cube([30, 100, 50], center=true);

            translate([0, 0, 5])
            cylinder(d=z_screw_d + 0.5, h=50, $fn=50);

            translate([0, 0, 5])
            hull() {
                translate([-5, 0, 50/2])
                cube([1, 35, 50], center=true);

                translate([35, 0, 50/2])
                cube([50, l, 50], center=true);
            }

            translate([0, -50/2, 37.9])
            rotate([45, 0, 0])
            cube([120, 50, 20], center=true);
            ...
            translate([-30/2 - z_screw_d/2 - 1, 80/2, 5.01])
            rotate([90, 180, 0])
            male_dovetail(80);

            translate([-z_screw_d/2 - 1.01, 40 + 9, 30/2 + 5])
            rotate([90, 90, 0])
            male_dovetail(40);

            translate([-z_screw_d/2 - 1.01, -9, 30/2 + 5])
            rotate([90, 90, 0])
            male_dovetail(40);

            translate([-30 - z_screw_d/2 - 1, 80/2, 30/2 + 5])
            rotate([90, -90, 0])
            male_dovetail(80);

            translate([-30 - z_screw_d/2 - 8, 0, 30/2 + 5])
            cube([5, 10, 5], center=true);

            translate([0, 0, 34])
            rotate([45, 0, 0])
            cube([180, 8, 8], center=true);

            motor_plate_holes(h=5, bolt_head_cones=true);

            translate([
                -motor_bolt_hole_distance/2,
                motor_bolt_hole_distance/2, 5
            ])
            cylinder(d=bolt_head_hole_dia, h=50, $fn=20);
    ...
    // supports
    translate([-43.5, -16.5, 0])
    cylinder(d=4, h=4.2);

    translate([-44.5, -22.5, 0])
    cylinder(d=4, h=8);
...
module z_motor_mount(supports=true) {
    difference() {
        union() {
            translate([0, 0, 30/2])
            extention_side(supports=supports);
...
module z_motor_support_base() {
    difference() {
        ...
        rotate([90, 0, 0])
        male_dovetail(60, bridge_extra=0.2, center=true);
    }
}
