                ...
                intersection(){
                    ...
                    difference(){
                        union(){
                            ...
                            // couplers
                            translate([-units*unit_length/2+slop, 12.7, -4]) rotate([0,0,90]) scale([0.95,0.95,0.95]) male_dovetail(3);
                            translate([-units*unit_length/2+slop, 12.7, -4]) rotate([0,0,-90]) scale([0.95,0.95,0.95]) male_dovetail(1);
                        ...
                        // coupler holes
                        translate([units*unit_length/2, 12.7, -4]) rotate([0,0,90]) male_dovetail(3+slop);
...
%translate([0,-3.5,13.5]) rotate([-90,0,0]) do_motor_mount();
%mirror([0,1,0]) translate([0,-3.5,13.5]) rotate([-90,0,0]) do_motor_mount();
